...
>(({ className, ...props }, ref) => (
  <SwitchPrimitives.Root
    ref={ref}
    className={cn(
      "peer inline-flex h-6 w-11 shrink-0 cursor-pointer items-center rounded-full border-2 transition-colors outline-none",
      "border-border bg-background data-[state=checked]:bg-primary data-[state=checked]:border-primary",
  ...
  >
    <SwitchPrimitives.Thumb
      ...
      style={{
        backgroundColor: "hsl(var(--foreground) / 1)",
      }}
    />
  </SwitchPrimitives.Root>
))
